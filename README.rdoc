...
* Build Status: http://travis-ci.org/josephholsten/rets4r http://travis-ci.org/josephholsten/rets4r.png
* Mailing List: rets4r@librelist.com http://librelist.com/browser/rets4r/
